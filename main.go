...
func main() {
	var plainText string = "1H2e3l4l5o6 $S%E@x!y! "
	var cipherText string = ciphers.BaconCipherEncrypt(plainText)
	decryptedText, _ := ciphers.BaconCipherDecrypt(cipherText)
